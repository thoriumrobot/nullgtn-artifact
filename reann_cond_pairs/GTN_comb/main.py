...
if __name__ == '__main__':
    ...
    with open('/home/k/ks225/ablation/data2/%s/node_features.pkl' % args.dataset,'rb') as f:
        node_features = pickle.load(f)
    with open('/home/k/ks225/ablation/data2/%s/edges.pkl' % args.dataset,'rb') as f:
        edges = pickle.load(f)
    with open('/home/k/ks225/ablation/data2/%s/labels.pkl' % args.dataset,'rb') as f:
        labels = pickle.load(f)
    if args.dataset == 'PPI':
        with open('/home/k/ks225/ablation/data2/%s/ppi_tvt_nids.pkl' % args.dataset, 'rb') as fp:
            nids = pickle.load(fp)
