...
public class RegistryAliasGroup {
    ...
    private static final ImmutableList<ImmutableSet<String>> REGISTRY_ALIAS_GROUPS = // Docker Hub alias group
    ImmutableList.// Docker Hub alias group
    of(ImmutableSet.of("registry.hub.docker.com", "index.docker.io"));
