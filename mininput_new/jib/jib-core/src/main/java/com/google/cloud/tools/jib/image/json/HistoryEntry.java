...
public class HistoryEntry implements JsonTemplate {
    ...
    public static class Builder {
        ...
        public HistoryEntry build() {
            return new HistoryEntry(creationTimestamp == null ? null : creationTimestamp.toString(), author, createdBy, comment, emptyLayer);
        }
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof HistoryEntry) {
            ...
            return Objects.equals(otherHistory.creationTimestamp, creationTimestamp) && Objects.equals(otherHistory.author, author) && Objects.equals(otherHistory.createdBy, createdBy) && Objects.equals(otherHistory.comment, comment) && Objects.equals(otherHistory.emptyLayer, emptyLayer);
        }
        return false;
    }
