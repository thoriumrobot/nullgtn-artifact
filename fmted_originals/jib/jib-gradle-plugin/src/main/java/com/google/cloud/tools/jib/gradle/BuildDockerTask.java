...
public class BuildDockerTask extends DefaultTask implements JibTask {
    ...
    public void buildDocker() throws InvalidImageReferenceException, IOException, BuildStepsExecutionException, CacheDirectoryCreationException, MainClassInferenceException, InferredAuthRetrievalException {
        ...
        try {
            ...
            PluginConfigurationProcessor pluginConfigurationProcessor = PluginConfigurationProcessor.processCommonConfigurationForDockerDaemonImage(new GradleRawConfiguration(jibExtension), ignored -> java.util.Optional.empty(), projectProperties, dockerClientParameters.getExecutable(), dockerClientParameters.getEnvironment(), gradleHelpfulSuggestionsBuilder.build());
