...
public class BuildTarTask extends DefaultTask implements JibTask {
    ...
    public FileCollection getInputFiles() {
        return GradleProjectProperties.getInputFiles(Preconditions.checkNotNull(jibExtension).getExtraDirectory().getPath().toFile(), getProject());
    }
    ...
    public void buildTar() throws InvalidImageReferenceException, BuildStepsExecutionException, IOException, CacheDirectoryCreationException, MainClassInferenceException, InferredAuthRetrievalException {
        ...
        try {
            ...
            PluginConfigurationProcessor pluginConfigurationProcessor = PluginConfigurationProcessor.processCommonConfigurationForTarImage(new GradleRawConfiguration(jibExtension), ignored -> Optional.empty(), projectProperties, tarOutputPath, gradleHelpfulSuggestionsBuilder.build());
