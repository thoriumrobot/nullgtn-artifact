...
public abstract class JibPluginConfiguration extends AbstractMojo {
    ...
    @Parameter(defaultValue = "false", required = true, property = PropertyNames.USE_ONLY_PROJECT_CACHE)
    ...
    Set<String> getTargetImageAdditionalTags() {
        if (System.getProperty(PropertyNames.TO_TAGS) != null) {
            return ImmutableSet.copyOf(ConfigurationPropertyValidator.parseListProperty(System.getProperty(PropertyNames.TO_TAGS)));
        }
    ...
    List<String> getEntrypoint() {
        if (System.getProperty(PropertyNames.CONTAINER_ENTRYPOINT) != null) {
            return ConfigurationPropertyValidator.parseListProperty(System.getProperty(PropertyNames.CONTAINER_ENTRYPOINT));
        }
    ...
    List<String> getJvmFlags() {
        if (System.getProperty(PropertyNames.CONTAINER_JVM_FLAGS) != null) {
            return ConfigurationPropertyValidator.parseListProperty(System.getProperty(PropertyNames.CONTAINER_JVM_FLAGS));
        }
    ...
    Map<String, String> getEnvironment() {
        if (System.getProperty(PropertyNames.CONTAINER_ENVIRONMENT) != null) {
            return ConfigurationPropertyValidator.parseMapProperty(System.getProperty(PropertyNames.CONTAINER_ENVIRONMENT));
        }
    ...
    List<String> getArgs() {
        if (System.getProperty(PropertyNames.CONTAINER_ARGS) != null) {
            return ConfigurationPropertyValidator.parseListProperty(System.getProperty(PropertyNames.CONTAINER_ARGS));
        }
    ...
    List<String> getExposedPorts() {
        if (System.getProperty(PropertyNames.CONTAINER_PORTS) != null) {
            return ConfigurationPropertyValidator.parseListProperty(System.getProperty(PropertyNames.CONTAINER_PORTS));
        }
    ...
    List<String> getVolumes() {
        if (System.getProperty(PropertyNames.CONTAINER_VOLUMES) != null) {
            return ConfigurationPropertyValidator.parseListProperty(System.getProperty(PropertyNames.CONTAINER_VOLUMES));
        }
    ...
    Map<String, String> getLabels() {
        if (System.getProperty(PropertyNames.CONTAINER_LABELS) != null) {
            return ConfigurationPropertyValidator.parseMapProperty(System.getProperty(PropertyNames.CONTAINER_LABELS));
        }
    ...
    Optional<Path> getExtraDirectoryPath() {
        ...
        return extraDirectory.path == null ? Optional.empty() : Optional.of(extraDirectory.path.toPath());
    }
    ...
    List<PermissionConfiguration> getExtraDirectoryPermissions() {
        if (System.getProperty(PropertyNames.EXTRA_DIRECTORY_PERMISSIONS) != null) {
            return ConfigurationPropertyValidator.parseMapProperty(System.getProperty(PropertyNames.EXTRA_DIRECTORY_PERMISSIONS)).entrySet().stream().map(entry -> new PermissionConfiguration(entry.getKey(), entry.getValue())).collect(Collectors.toList());
        }
