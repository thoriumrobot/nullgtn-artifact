...
public class PackageGoalsMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        mavenExecutionPlan.getMojoExecutions().stream().filter(mojoExecution -> "package".equals(mojoExecution.getLifecyclePhase())).filter(mojoExecution -> MavenProjectProperties.PLUGIN_NAME.equals(mojoExecution.getPlugin().getArtifactId())).map(MojoExecution::getGoal).forEach(System.out::println);
    }
}
