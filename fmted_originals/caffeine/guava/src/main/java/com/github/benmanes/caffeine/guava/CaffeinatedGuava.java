...
public final class CaffeinatedGuava {
     ...
     */
    @NonNull
    public static <K, V, K1 extends K, V1 extends V> Cache<K1, V1> build(@NonNull Caffeine<K, V> builder) {
     ...
     */
    @NonNull
    public static <K, V, K1 extends K, V1 extends V> LoadingCache<K1, V1> build(@NonNull Caffeine<K, V> builder, @NonNull CacheLoader<? super K1, V1> loader) {
     ...
     */
    @NonNull
    public static <K, V, K1 extends K, V1 extends V> LoadingCache<K1, V1> build(@NonNull Caffeine<K, V> builder, com.github.benmanes.caffeine.cache.@NonNull CacheLoader<? super K1, V1> loader) {
