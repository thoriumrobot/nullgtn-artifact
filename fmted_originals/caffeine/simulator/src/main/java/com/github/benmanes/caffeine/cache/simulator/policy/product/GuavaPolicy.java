...
public final class GuavaPolicy implements Policy {
    ...
    public GuavaPolicy(Config config) {
        ...
        cache = CacheBuilder.newBuilder().maximumSize(settings.maximumSize()).initialCapacity(settings.maximumSize()).removalListener(notification -> policyStats.recordEviction()).build();
    }
