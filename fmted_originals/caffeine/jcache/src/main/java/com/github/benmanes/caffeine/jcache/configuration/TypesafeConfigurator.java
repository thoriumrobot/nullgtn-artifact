...
public final class TypesafeConfigurator {
    ...
    private static final class Configurator<K, V> {
        ...
        public void addLazyExpiration() {
            ...
            Factory<? extends ExpiryPolicy> factory = eternal ? EternalExpiryPolicy.factoryOf() : FactoryBuilder.factoryOf(new JCacheExpiryPolicy(creation, update, access));
        ...
        public void addEagerExpiration() {
            ...
            if (isSet("policy.eager-expiration.variable")) {
                configuration.setExpiryFactory(Optional.of(FactoryBuilder.factoryOf(merged.getString("policy.eager-expiration.variable"))));
            }
        }
