...
public class RequestCreator {
    ...
    public Bitmap get() throws IOException {
        ...
        RequestHandler.Result result = forRequest(picasso, picasso.dispatcher, picasso.cache, picasso.stats, action).hunt();
     ...
     * given {@code viewId}. This is used for loading bitmaps into a {@link Notification}.
     */
    public void into(@NonNull RemoteViews remoteViews, @IdRes int viewId, int notificationId, @NonNull Notification notification, @Nullable String notificationTag, @Nullable Callback callback) {
        long started = System.nanoTime();
        if (remoteViews == null) {
        ...
        Request request = createRequest(started);
        RemoteViewsAction action = new NotificationAction(picasso, request, errorResId, new RemoteViewsTarget(remoteViews, viewId), notificationId, notification, notificationTag, callback);
     ...
     * given {@code viewId}. This is used for loading bitmaps into all instances of a widget.
     */
    public void into(@NonNull RemoteViews remoteViews, @IdRes int viewId, int appWidgetId, @Nullable Callback callback) {
     ...
     * given {@code viewId}. This is used for loading bitmaps into all instances of a widget.
     */
    public void into(@NonNull RemoteViews remoteViews, @IdRes int viewId, @NonNull int[] appWidgetIds, @Nullable Callback callback) {
        long started = System.nanoTime();
        if (remoteViews == null) {
            throw new IllegalArgumentException("remoteViews must not be null.");
        }
        ...
        Request request = createRequest(started);
        RemoteViewsAction action = new AppWidgetAction(picasso, request, errorResId, new RemoteViewsTarget(remoteViews, viewId), appWidgetIds, callback);
        performRemoteViewInto(request, action);
    }
