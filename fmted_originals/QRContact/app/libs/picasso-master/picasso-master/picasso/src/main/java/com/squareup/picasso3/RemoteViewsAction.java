...
abstract class RemoteViewsAction extends Action {
    ...
    RemoteViewsAction(Picasso picasso, Request data, @DrawableRes int errorResId, @NonNull RemoteViewsTarget target, @Nullable Callback callback) {
        super(picasso, data);
    ...
    static class AppWidgetAction extends RemoteViewsAction {
        ...
        AppWidgetAction(Picasso picasso, Request data, @DrawableRes int errorResId, RemoteViewsTarget target, int[] appWidgetIds, @Nullable Callback callback) {
    ...
    static class NotificationAction extends RemoteViewsAction {
        ...
        NotificationAction(Picasso picasso, Request data, @DrawableRes int errorResId, RemoteViewsTarget target, int notificationId, Notification notification, @Nullable String notificationTag, @Nullable Callback callback) {
            super(picasso, data, errorResId, target, callback);
