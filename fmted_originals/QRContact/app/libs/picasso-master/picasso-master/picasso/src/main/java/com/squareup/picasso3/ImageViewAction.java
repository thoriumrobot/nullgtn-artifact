...
class ImageViewAction extends Action {
    ...
    ImageViewAction(Picasso picasso, ImageView target, Request data, @Nullable Drawable errorDrawable, @DrawableRes int errorResId, boolean noFade, @Nullable Callback callback) {
        super(picasso, data);
        this.target = target;
