...
public abstract class RequestHandler {
    ...
    public static final class Result {
        ...
        public Result(@NonNull Bitmap bitmap, @NonNull Picasso.LoadedFrom loadedFrom, int exifRotation) {
        ...
        private Result(@Nullable Bitmap bitmap, @Nullable Drawable drawable, @NonNull Picasso.LoadedFrom loadedFrom, int exifRotation) {
            this.bitmap = bitmap;
     ...
     */
    public abstract void load(@NonNull Picasso picasso, @NonNull Request request, @NonNull Callback callback) throws IOException;
