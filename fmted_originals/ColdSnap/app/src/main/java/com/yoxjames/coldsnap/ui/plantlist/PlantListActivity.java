...
public class PlantListActivity extends BaseColdsnapActivity<PlantListPresenter> implements PlantListMvpView {
    ...
    protected PlantListRecyclerView plantListView;
    ...
    protected void inject() {
        ((ColdSnapApplication) getApplicationContext()).getInjector().mainActivitySubcomponent(new PlantListModule(this)).inject(this);
    }
