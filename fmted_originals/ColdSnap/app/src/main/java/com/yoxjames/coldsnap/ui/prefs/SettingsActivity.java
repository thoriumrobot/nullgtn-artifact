...
public class SettingsActivity extends BaseColdsnapActivity<SettingsActivityPresenter> implements SettingsActivityView {
    ...
    protected void inject() {
        ((ColdSnapApplication) getApplicationContext()).getInjector().settingsActivitySubcomponent(new SettingsActivityModule(this)).inject(this);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getFragmentManager().beginTransaction().replace(R.id.fl_fragment_container, new SettingsFragment()).commit();
    }
}
